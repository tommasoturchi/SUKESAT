...
#pragma omp parallel for if(THREADS>1) num_threads(THREADS) shared(c,gram,testing_progress,klen,m,reviews,train,tsize,u) schedule(static)
...
#pragma omp critical
		...
		cout << "An error occurred, moving on..." << endl;
	}
